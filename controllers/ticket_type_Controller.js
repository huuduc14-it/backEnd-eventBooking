...
exports.updateTicket = async (req, res) => {
    try {
        ...
        // We pass req.body directly. 
        // If description is missing (undefined), the Model will ignore it.
        ...
        await TicketTypeModel.update(ticketTypeId, { 
            ...
            price, 
            total_quantity, 
            description // It is okay if this is undefined now!
        });
...
exports.addTicket = async (req, res) => {
  try {
    ...
    const [events] = await db
      .promise()
      .execute("SELECT user_id FROM events WHERE event_id = ?", [event_id]);
    ...
    const newId = await TicketTypeModel.add(event_id, {
      ...
      price,
      total_quantity,
      description: description || null, // <--- THIS FIXES THE CRASH
    });
